...
use App\Services\PdvHealthService;
...
{
    public function index(Request $request, AuthorizationService $authorization, PdvConnectionService $connections, PdvHealthService $healthService): View
    {
        ...
        $health = $healthService->forConnections($locations->flatMap->pdvConnections->merge($legacyConnections));

        return view('pdv.index', compact('locations', 'legacyConnections', 'credentialConfigured', 'health'));
    }
