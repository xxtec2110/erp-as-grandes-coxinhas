...
class AgentToolExecutor
{
    ...
    public function execute(string $name, array $input, User $user, bool $confirmed = false): mixed
    {
        ...
        return match ($name) {
            ...
            'purchases.documents.list' => $this->purchases->documents($user),
