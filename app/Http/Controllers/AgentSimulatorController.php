...
class AgentSimulatorController extends Controller
{
    ...
    {
        $data = $request->validate(['provider' => ['required', 'in:fake,live'], 'text' => ['nullable', 'required_without:attachment', 'string', 'max:4000'], 'attachment' => ['nullable', 'file', 'mimes:pdf,jpg,jpeg,png', 'extensions:pdf,jpg,jpeg,png'], 'location_id' => ['nullable', 'required_with:attachment', 'integer', 'exists:locations,id']]);
