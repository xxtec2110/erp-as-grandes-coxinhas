...
class OpenAiProvider implements AiProviderInterface
{
    ...
    public function interpret(AgentMessage $message, array $availableTools, array $context = []): ?AiInterpretation
    {
        ...
        $payload = ['model' => $model, 'store' => false, 'instructions' => $this->prompt->build($tools), 'input' => [['role' => 'user', 'content' => $content]], 'text' => ['format' => ['type' => 'json_schema', 'name' => 'erp_agent_interpretation', 'strict' => false, 'schema' => AgentInterpretationSchema::definition()]]];
